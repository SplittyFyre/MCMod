package org.splitfire.mod.init.entities.models;
...
public class ModelClockKnight extends ModelBase
{
    ...
    public ModelClockKnight()
    {
        this(0.0F);
    }

    public ModelClockKnight(float p_i46366_1_)
    {
        int i = 6;
