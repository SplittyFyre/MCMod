...
public class BlowGun extends ItemBow{
    ...
    {
        return stack.getItem() instanceof TinCan;    //change this to ammunition type
    }
            ...
            if (!itemstack.isEmpty() || flag)
            {
                ...
                if ((double)f >= 0.1D)
                {
                    ...
                    if (!worldIn.isRemote)
                    {
                        ...
                        if (j > 0)
                        {
                            entityarrow.setDamage(entityarrow.getDamage() + (double)j * 0.5D + 0.5D);  //how powerful
                        }
